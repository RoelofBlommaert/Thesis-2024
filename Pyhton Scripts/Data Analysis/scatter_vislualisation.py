...
FC_views = merged[['viewCount', 'likeCount', 'commentCount', 'Luminance Complexity',
                    'Edge Density', 'Color Complexity']]
DC_views = merged[['viewCount', 'likeCount', 'commentCount', 'Irregularity of Object Arrangement',
                    'Asymmetry of Object Arrangement', 'Unique Objects Count']]
g = sns.PairGrid(FC_views)
g.map(plt.scatter)
plt.show()