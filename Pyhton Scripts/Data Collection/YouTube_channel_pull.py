...
#This file uses data generated by from `Scripts/Data Collection/Youtube_video_pull.py`.
#RUN `Scripts/Data Collection/Youtube_video_pull.py` FIRST.
...
file_path = 'Data/youtube_videos_raw.csv'
...
merged_df.to_csv('Data/youtube_channels_videos_raw.csv', index=False)
